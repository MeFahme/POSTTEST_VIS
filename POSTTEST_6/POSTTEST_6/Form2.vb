Public Class Form2
    ...
    Private Sub btnSimpanTransaksi_Click(sender As Object, e As EventArgs) Handles btnSimpanTransaksi.Click
        ...
        Dim konfirmasi As DialogResult =
            MessageBox.Show("Simpan transaksi penjualan?" &
                            "Total: Rp " & totalHarga.ToString("N0"),
                            "Konfirmasi", MessageBoxButtons.YesNo, MessageBoxIcon.Question)

        If konfirmasi = DialogResult.Yes Then
            Dim kodePlg As String = ""
            If cmbPelanggan.SelectedIndex >= 0 AndAlso cmbPelanggan.SelectedValue IsNot Nothing Then
                kodePlg = cmbPelanggan.SelectedValue.ToString()
            End If
    ...
    Private Sub btnHapusNota_Click(sender As Object, e As EventArgs) Handles btnHapusNota.Click
        ...
        Dim konfirmasi As DialogResult =
            MessageBox.Show("Hapus nota " & nota & "?" &
    ...
    Private Sub cmbPelanggan_SelectedIndexChanged(sender As Object, e As EventArgs) Handles cmbPelanggan.SelectedIndexChanged
        If cmbPelanggan.SelectedIndex <> -1 AndAlso cmbPelanggan.SelectedValue IsNot Nothing Then
            txtNamaPembeli.Text = cmbPelanggan.Text
        End If
    End Sub
End Class