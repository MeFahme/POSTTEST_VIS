Public Class Form3
    ...
    Private Sub AturKolomGrid()
        ...
        ' Sesuaikan lebar kolom supaya rapi
        For Each col As DataGridViewColumn In dgvPelanggan.Columns
            Select Case col.Name
                Case "KodePelanggan" : col.Width = 90
                Case "NamaPelanggan" : col.Width = 170
                Case "NoHP" : col.Width = 110
                Case "Alamat" : col.Width = 210
                Case "Email" : col.Width = 160
            End Select
        Next
    End Sub
