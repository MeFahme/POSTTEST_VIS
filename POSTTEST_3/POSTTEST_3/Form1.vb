...
Public Class Form1
	...
	Private Function CekData() As Boolean
		grupHobi = {cbGame, cbBaca, cbMancing, cbMancing, cbLukis, cbNulis, cbRenang, cbBerburu, cbBerkebun, cbMendaki, cbBertapa, cbMenempa}
		...
		If Not ValidasiTextBox(txtNoTelp, "Nomor Telpon Tidak Boleh Kosong") Then Return False
