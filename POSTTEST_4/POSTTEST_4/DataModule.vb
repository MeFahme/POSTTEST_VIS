...
Module DataModule
    ...
    Public Function BukaDataDariFile(ofd As OpenFileDialog) As Dictionary(Of String, String)
        ...
        ' Jika user menekan Cancel, kembalikan Nothing
        ...
        Try
            ...
            For Each baris As String In barisFile
                ...
                ' Memisahkan teks berdasarkan tanda "=" (contoh: Nama=Budi)
    ...
    ' Fungsi untuk mengambil data dari dictionary dengan aman
    'Public Function AmbilNilai(data As Dictionary(Of String, String), kunci As String) As String
    '    If data IsNot Nothing AndAlso data.ContainsKey(kunci) Then
    '        Return data(kunci)
    '    End If
    '    Return ""
    'End Function
