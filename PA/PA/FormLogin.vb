...
Public Class FormLogin
    ...
    Private Sub btnLogin_Click(sender As Object, e As EventArgs) Handles btnLogin.Click
        ...
        If ValidationModule.CekKosong(txtUsername, ErrorProvider1, "Username tidak boleh kosong!") Then
            adaError = True
        End If
        If ValidationModule.CekKosong(txtPassword, ErrorProvider1, "Password tidak boleh kosong!") Then
            adaError = True
        End If
        If adaError Then Exit Sub
        Try
            BukaKoneksi()
